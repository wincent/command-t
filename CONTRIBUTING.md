...
2. Edit metadata in `lua/wincent/commandt/version.lua` to reflect new `$VERSION` (remove `prerelease = '7-x-devel'`).
...
11. Edit metadata in `lua/wincent/commandt/version.lua` to show `prerelease ='7-x-devel'` and `version = 'x.y.z-7-x-devel'`.
