...
#define WATCHMAN_ARRAY_MARKER ((uint8_t)0x00)
#define WATCHMAN_OBJECT_MARKER ((uint8_t)0x01)
#define WATCHMAN_STRING_MARKER ((uint8_t)0x02)
#define WATCHMAN_INT8_MARKER ((uint8_t)0x03)
#define WATCHMAN_INT16_MARKER ((uint8_t)0x04)
#define WATCHMAN_INT32_MARKER ((uint8_t)0x05)
#define WATCHMAN_INT64_MARKER ((uint8_t)0x06)
#define WATCHMAN_DOUBLE_MARKER ((uint8_t)0x07)
#define WATCHMAN_TRUE ((uint8_t)0x08)
#define WATCHMAN_FALSE ((uint8_t)0x09)
#define WATCHMAN_NIL ((uint8_t)0x0a)
#define WATCHMAN_TEMPLATE_MARKER ((uint8_t)0x0b)
#define WATCHMAN_SKIP_MARKER ((uint8_t)0x0c)
...
static void watchman_append(watchman_request_t *w, const char *data, size_t length) {
    if (w->length + length > w->capacity) {
        if (length <= WATCHMAN_DEFAULT_STORAGE) {
            w->capacity += WATCHMAN_DEFAULT_STORAGE;
        } else {
            w->capacity += length + WATCHMAN_DEFAULT_STORAGE;
        }
